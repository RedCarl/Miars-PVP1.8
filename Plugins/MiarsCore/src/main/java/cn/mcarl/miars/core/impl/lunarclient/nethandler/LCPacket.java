package cn.mcarl.miars.core.impl.lunarclient.nethandler;
...
public abstract class LCPacket {
    ...
    public static LCPacket handle(byte[] data, Object attachment) {
        cn.mcarl.miars.core.impl.lunarclient.nethandler.ByteBufWrapper wrappedBuffer = new cn.mcarl.miars.core.impl.lunarclient.nethandler.ByteBufWrapper(Unpooled.wrappedBuffer(data));
    ...
    public static ByteBuf getPacketBuf(LCPacket packet) {
        cn.mcarl.miars.core.impl.lunarclient.nethandler.ByteBufWrapper wrappedBuffer = new cn.mcarl.miars.core.impl.lunarclient.nethandler.ByteBufWrapper(Unpooled.buffer());
    ...
    public abstract void write(cn.mcarl.miars.core.impl.lunarclient.nethandler.ByteBufWrapper buf) throws IOException;

    public abstract void read(cn.mcarl.miars.core.impl.lunarclient.nethandler.ByteBufWrapper buf) throws IOException;
    ...
    protected void writeBlob(cn.mcarl.miars.core.impl.lunarclient.nethandler.ByteBufWrapper b, byte[] bytes) {
