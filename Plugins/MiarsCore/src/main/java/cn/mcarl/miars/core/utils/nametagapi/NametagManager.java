...
public final class NametagManager {
    ...
    private static final HashMap<Integer,String> SN = new HashMap<>();

    //排序 按照TeamInfo的NAME进行排序
    private static final Map<TeamInfo, List<String>> teams = new HashMap<>();
...
//                }
    ...
    private static TeamInfo getTeamInfo(String prefix, String suffix) {
        ...
        return declareTeam(TEAM_NAME_PREFIX + SN.get(nextName()), prefix, suffix);
    }
