...
public class MySQLDatabase implements Database {
    ...
    private static String SAVE = "UPDATE UltraSkyWars SET Data=?, Kills=?, Wins=?, Deaths=?, Coins=?, Elo=? WHERE UUID=?";
    private static HashMap<UUID, SWPlayer> players = new HashMap<>();
    ...
    public void connect() {
        if (enabled) {
            ...
            config.setPoolName("UltraSkyWars " + UUID.randomUUID().toString());
