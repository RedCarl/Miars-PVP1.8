...
import io.github.Leonardo0013YT.UltraSkyWars.modules.mobfriends.friends.FriendSession;
...
public class MobFriendsListener implements Listener {
    ...
    public MobFriendsListener(UltraSkyWars plugin) {
        this.plugin = plugin;
    }
    ...
    public void onInteract(PlayerInteractEvent e) {
        ...
        if (UltraSkyWarsAPI.isPlayerGame(p)) {
            ...
            if (m.name().endsWith("SPAWN_EGG")) {
                ...
                Entity entity = spawnEntity(loc, dt);
