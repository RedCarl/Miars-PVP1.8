    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            switch (args[0].toLowerCase()) {
                ...
                case "kitsmenu":
                    ...
                    if (kitType.equals("SOLO") || kitType.equals("TEAM") || kitType.equals("RANKED")) {
                        ...
                        plugin.getUim().createKitSelectorMenu(p, kitType, true);
                    } else {
                ...
                case "killeffect":
                    ...
                    switch (args[1].toLowerCase()) {
                        ...
                        case "remove":
                            ...
                            csw3.getKilleffects().remove(id3);
                ...
                case "windeffect":
                    ...
                    switch (args[1].toLowerCase()) {
                        ...
                        case "remove":
                            ...
                            csw10.getWineffects().remove(id10);
                ...
                case "customjoin":
                    ...
                    if (!g.getServer().equals("")) {
                        if (g.getState().equals("WAITING") || g.getState().equals("STARTING") || p.hasPermission("ultraskywars.mod")) {
                        ...
                        case "solo":
                            if (game.getType().equals("solo")) {
                                if (!game.getServer().equals("")) {
                                    if (game.getState().equals("WAITING") || game.getState().equals("STARTING") || p.hasPermission("ultraskywars.mod")) {
            ...
            switch (args[0].toLowerCase()) {
                case "reconnect":
                    plugin.reconnect();
                    sender.sendMessage("§aRedis reconnected correctly.");
                    break;
                case "perks":
                    if (args.length < 4) {
                        sendHelp(sender);
                ...
                case "balloon":
                    ...
                    Player c1 = Bukkit.getPlayer(args[2]);
                    if (c1 == null) {
                        sender.sendMessage(plugin.getLang().get(null, "setup.noOnline"));
                        return true;
                    }
                    int id1;
                    try {
                        ...
                        sender.sendMessage(plugin.getLang().get(null, "setup.noNumber"));
                        return true;
                    }
                    SWPlayer csw1 = plugin.getDb().getSWPlayer(c1);
                    switch (args[1].toLowerCase()) {
                        case "add":
                            if (csw1.getBalloons().contains(id1)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.alreadyHas"));
                                return true;
                            }
                            csw1.getBalloons().add(id1);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "Balloon").replaceAll("<id>", String.valueOf(id1)).replaceAll("<player>", c1.getName()));
                            break;
                        case "remove":
                            if (!csw1.getBalloons().contains(id1)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                                return true;
                            }
                            csw1.getBalloons().remove(id1);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "Balloon").replaceAll("<id>", String.valueOf(id1)).replaceAll("<player>", c1.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "glass":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            csw2.getGlasses().add(id2);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "Glass").replaceAll("<id>", String.valueOf(id2)).replaceAll("<player>", c2.getName()));
                            break;
                        case "remove":
                            if (!csw2.getGlasses().contains(id2)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                            ...
                            csw2.getGlasses().remove(id2);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "Glass").replaceAll("<id>", String.valueOf(id2)).replaceAll("<player>", c2.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "killeffect":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            csw3.getKilleffects().add(id3);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "KillEffect").replaceAll("<id>", String.valueOf(id3)).replaceAll("<player>", c3.getName()));
                            break;
                        case "remove":
                            if (!csw3.getKilleffects().contains(id3)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                            ...
                            csw3.getKilleffects().remove(id3);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "KillEffect").replaceAll("<id>", String.valueOf(id3)).replaceAll("<player>", c3.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "killsound":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            csw4.getKillsounds().add(id4);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "KillSound").replaceAll("<id>", String.valueOf(id4)).replaceAll("<player>", c4.getName()));
                            break;
                        case "remove":
                            if (!csw4.getKillsounds().contains(id4)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                            ...
                            csw4.getKillsounds().remove(id4);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "KillSound").replaceAll("<id>", String.valueOf(id4)).replaceAll("<player>", c4.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "kit":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            csw5.addKitLevel(id5, 1);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "Kit").replaceAll("<id>", String.valueOf(id5)).replaceAll("<player>", c5.getName()));
                            break;
                        case "remove":
                            if (!csw5.getKits().containsKey(id5)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                            ...
                            csw5.getKits().remove(id5);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "Kit").replaceAll("<id>", String.valueOf(id5)).replaceAll("<player>", c5.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "parting":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            csw6.getPartings().add(id6);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "Parting").replaceAll("<id>", String.valueOf(id6)).replaceAll("<player>", c6.getName()));
                            break;
                        case "remove":
                            if (!csw6.getPartings().contains(id6)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                            ...
                            csw6.getPartings().remove(id6);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "Parting").replaceAll("<id>", String.valueOf(id6)).replaceAll("<player>", c6.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "taunt":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            csw7.getTaunts().add(id7);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "Taunt").replaceAll("<id>", String.valueOf(id7)).replaceAll("<player>", c7.getName()));
                            break;
                        case "remove":
                            if (!csw7.getTaunts().contains(id7)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                            ...
                            csw7.getTaunts().remove(id7);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "Taunt").replaceAll("<id>", String.valueOf(id7)).replaceAll("<player>", c7.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "trail":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            csw8.getTrails().add(id8);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "Trail").replaceAll("<id>", String.valueOf(id8)).replaceAll("<player>", c8.getName()));
                            break;
                        case "remove":
                            if (!csw8.getTrails().contains(id8)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                            ...
                            csw8.getTrails().remove(id8);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "Trail").replaceAll("<id>", String.valueOf(id8)).replaceAll("<player>", c8.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "windance":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            csw9.getWindances().add(id9);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "WinDance").replaceAll("<id>", String.valueOf(id9)).replaceAll("<player>", c9.getName()));
                            break;
                        case "remove":
                            if (!csw9.getWindances().contains(id9)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                            ...
                            csw9.getWindances().remove(id9);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "WinDance").replaceAll("<id>", String.valueOf(id9)).replaceAll("<player>", c9.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "windeffect":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            csw10.getWineffects().add(id10);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.add").replaceAll("<type>", "WinEffect").replaceAll("<id>", String.valueOf(id10)).replaceAll("<player>", c10.getName()));
                            break;
                        case "remove":
                            if (!csw10.getWineffects().contains(id10)) {
                                sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.noHas"));
                            ...
                            csw10.getWineffects().remove(id10);
                            sender.sendMessage(plugin.getLang().get(null, "messages.cosmetics.remove").replaceAll("<type>", "WinEffect").replaceAll("<id>", String.valueOf(id10)).replaceAll("<player>", c10.getName()));
                            break;
                        default:
                            sendHelp(sender);
                            break;
                ...
                case "forcejoin":
                    ...
                    if (plugin.getGm().isPlayerInGame(on67)) {
                        sender.sendMessage(plugin.getLang().get(null, "messages.alreadyGame"));
                        return true;
                    }
                    Game game2 = plugin.getGm().getGameByName(name2);
                    if (game2 == null) {
                        sender.sendMessage(plugin.getLang().get(null, "messages.noGameExists"));
                        return true;
                    }
                    switch (type2.toLowerCase()) {
                        case "solo":
                            if (game2 instanceof UltraGame) {
                                ...
                                sender.sendMessage(plugin.getLang().get(null, "messages.noGameType"));
                            }
                            break;
                        case "team":
                ...
                case "coins":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            plugin.getAdm().addCoins(on, amount);
                            sender.sendMessage(plugin.getLang().get(null, "coins.add.you").replaceAll("<coins>", String.valueOf(amount)).replaceAll("<player>", on.getName()));
                            on.sendMessage(plugin.getLang().get(null, "coins.add.receiver").replaceAll("<coins>", String.valueOf(amount)).replaceAll("<sender>", sender.getName()));
                            Utils.updateSB(on);
                            break;
                        case "remove":
                            Player on1 = Bukkit.getPlayer(args[2]);
                            ...
                            SWPlayer sw1 = plugin.getDb().getSWPlayer(on1);
                            plugin.getAdm().removeCoins(on1, amount1);
                            sender.sendMessage(plugin.getLang().get(null, "coins.remove.you").replaceAll("<coins>", String.valueOf(amount1)).replaceAll("<player>", on1.getName()));
                            on1.sendMessage(plugin.getLang().get(null, "coins.remove.receiver").replaceAll("<coins>", String.valueOf(amount1)).replaceAll("<sender>", sender.getName()));
                            Utils.updateSB(on1);
                            break;
                        case "set":
                            Player on2 = Bukkit.getPlayer(args[2]);
                            ...
                            SWPlayer sw2 = plugin.getDb().getSWPlayer(on2);
                            plugin.getAdm().setCoins(on2, amount2);
                            sender.sendMessage(plugin.getLang().get(null, "coins.set.you").replaceAll("<coins>", String.valueOf(amount2)).replaceAll("<player>", on2.getName()));
                            on2.sendMessage(plugin.getLang().get(null, "coins.set.receiver").replaceAll("<coins>", String.valueOf(amount2)).replaceAll("<sender>", sender.getName()));
                            Utils.updateSB(on2);
                            break;
                        default:
                            sendHelp(sender);
                ...
                case "souls":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            SWPlayer sw = plugin.getDb().getSWPlayer(on);
                            sw.addSouls(amount);
                            sender.sendMessage(plugin.getLang().get(null, "souls.add.you").replaceAll("<souls>", String.valueOf(amount)).replaceAll("<player>", on.getName()));
                            on.sendMessage(plugin.getLang().get(null, "souls.add.receiver").replaceAll("<souls>", String.valueOf(amount)).replaceAll("<sender>", sender.getName()));
                            Utils.updateSB(on);
                            break;
                        case "remove":
                            Player on1 = Bukkit.getPlayer(args[2]);
                            ...
                            SWPlayer sw1 = plugin.getDb().getSWPlayer(on1);
                            sw1.removeSouls(amount1);
                            sender.sendMessage(plugin.getLang().get(null, "souls.remove.you").replaceAll("<souls>", String.valueOf(amount1)).replaceAll("<player>", on1.getName()));
                            on1.sendMessage(plugin.getLang().get(null, "souls.remove.receiver").replaceAll("<souls>", String.valueOf(amount1)).replaceAll("<sender>", sender.getName()));
                            Utils.updateSB(on1);
                            break;
                        case "set":
                            Player on2 = Bukkit.getPlayer(args[2]);
                            ...
                            SWPlayer sw2 = plugin.getDb().getSWPlayer(on2);
                            sw2.setSouls(amount2);
                            sender.sendMessage(plugin.getLang().get(null, "souls.set.you").replaceAll("<souls>", String.valueOf(amount2)).replaceAll("<player>", on2.getName()));
                            on2.sendMessage(plugin.getLang().get(null, "souls.set.receiver").replaceAll("<souls>", String.valueOf(amount2)).replaceAll("<sender>", sender.getName()));
                            Utils.updateSB(on2);
                            break;
                        default:
                            sendHelp(sender);
                ...
                case "cubelets":
                    ...
                    if (!plugin.getIjm().isCubeletsInjection()) {
                        sender.sendMessage(plugin.getLang().get(null, "injections.cubelets"));
                        return true;
                    }
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            SWPlayer sw = plugin.getDb().getSWPlayer(on);
                            sw.addCubelets(amount);
                            sender.sendMessage(plugin.getLang().get(null, "cubelets.add.you").replaceAll("<cubelets>", String.valueOf(amount)).replaceAll("<player>", on.getName()));
                            on.sendMessage(plugin.getLang().get(null, "cubelets.add.receiver").replaceAll("<cubelets>", String.valueOf(amount)).replaceAll("<sender>", sender.getName()));
                            Utils.updateSB(on);
                            break;
                        case "remove":
                            Player on1 = Bukkit.getPlayer(args[2]);
                            ...
                            SWPlayer sw1 = plugin.getDb().getSWPlayer(on1);
                            sw1.removeCubelets(amount1);
                            sender.sendMessage(plugin.getLang().get(null, "cubelets.remove.you").replaceAll("<cubelets>", String.valueOf(amount1)).replaceAll("<player>", on1.getName()));
                            on1.sendMessage(plugin.getLang().get(null, "cubelets.remove.receiver").replaceAll("<cubelets>", String.valueOf(amount1)).replaceAll("<sender>", sender.getName()));
                            Utils.updateSB(on1);
                            break;
                        case "set":
                            Player on2 = Bukkit.getPlayer(args[2]);
                            ...
                            SWPlayer sw2 = plugin.getDb().getSWPlayer(on2);
                            sw2.setCubelets(amount2);
                            sender.sendMessage(plugin.getLang().get(null, "cubelets.set.you").replaceAll("<cubelets>", String.valueOf(amount2)).replaceAll("<player>", on2.getName()));
                            on2.sendMessage(plugin.getLang().get(null, "cubelets.set.receiver").replaceAll("<cubelets>", String.valueOf(amount2)).replaceAll("<sender>", sender.getName()));
                            Utils.updateSB(on2);
                            break;
                        default:
                            sendHelp(sender);
                ...
                case "xp":
                    ...
                    switch (args[1].toLowerCase()) {
                        case "add":
                            ...
                            SWPlayer sw = plugin.getDb().getSWPlayer(on);
                            sw.addXp(amount);
                            sender.sendMessage(plugin.getLang().get(null, "xp.add.you").replaceAll("<xp>", String.valueOf(amount)).replaceAll("<player>", on.getName()));
                            on.sendMessage(plugin.getLang().get(null, "xp.add.receiver").replaceAll("<xp>", String.valueOf(amount)).replaceAll("<sender>", sender.getName()));
                            plugin.getLvl().checkUpgrade(on);
                            Utils.updateSB(on);
                            break;
                        case "remove":
                            ...
                            SWPlayer sw1 = plugin.getDb().getSWPlayer(on1);
                            sw1.removeXp(amount1);
                            sender.sendMessage(plugin.getLang().get(null, "xp.remove.you").replaceAll("<xp>", String.valueOf(amount1)).replaceAll("<player>", on1.getName()));
                            on1.sendMessage(plugin.getLang().get(null, "xp.remove.receiver").replaceAll("<xp>", String.valueOf(amount1)).replaceAll("<sender>", sender.getName()));
                            plugin.getLvl().checkUpgrade(on1);
                            Utils.updateSB(on1);
                            break;
                        case "set":
                            ...
                            SWPlayer sw2 = plugin.getDb().getSWPlayer(on2);
                            sw2.setXp(amount2);
                            sender.sendMessage(plugin.getLang().get(null, "xp.set.you").replaceAll("<xp>", String.valueOf(amount2)).replaceAll("<player>", on2.getName()));
                            on2.sendMessage(plugin.getLang().get(null, "xp.set.receiver").replaceAll("<xp>", String.valueOf(amount2)).replaceAll("<sender>", sender.getName()));
                            plugin.getLvl().checkUpgrade(on2);
                            Utils.updateSB(on2);
                            break;
                        default:
