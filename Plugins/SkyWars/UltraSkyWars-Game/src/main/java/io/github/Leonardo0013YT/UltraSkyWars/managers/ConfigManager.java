...
public class ConfigManager {
    ...
    private int enderPearlSeconds, rankedLevels, maxMobFriends, maxCollectHeads, timeBorderReduction, minBorderReduction, rInvGlasses, rInvWinEffects, rInvBalloons, rInvKillEffects, rInvKits, rInvKillSounds, rInvTrails, rInvWinDances, rInvTaunts, updatePlayersPlaceholder, maxItemsChest, ticksAni3, executesAni3, ticksAni1, upYAni1, cubeletChance, gamesToRestart, itemLobbySlot, winTime, progressBarAmount, maxMultiplier, starting, pregame, coinsKill, coinsWin, coinsAssists, xpKill, xpWin, xpAssists, soulsKill, soulsWin, soulsAssists;
    private XMaterial next, last, deselect, challenges, back, lobby, team, spectate, options, play, leave, kits, setup, center, island, soulwell;
    ...
    public void reload() {
        ...
        this.enabledGameRestart = plugin.getConfig().getBoolean("bungee.enabledGameRestart");
        this.onPaper = plugin.getConfig().getBoolean("bungee.autoJoin.onPaper");
        this.onFinish = plugin.getConfig().getBoolean("bungee.autoJoin.onFinish");
        this.enableMobSpawning = plugin.getConfig().getBoolean("specials.enableMobSpawning");
        ...
        this.PlayerBalancerEnabled = plugin.getConfig().getBoolean("addons.PlayerBalancer.enabled");
        this.PlayerBalancerSection = plugin.getConfig().getString("addons.PlayerBalancer.section");
        ...
        this.back = XMaterial.matchXMaterial(plugin.getConfig().getString("materials.closeitem")).orElse(XMaterial.BOOK);
