...
import io.github.Leonardo0013YT.UltraSkyWars.cosmetics.killeffects.*;
import io.github.Leonardo0013YT.UltraSkyWars.cosmetics.taunts.Taunt;
import io.github.Leonardo0013YT.UltraSkyWars.cosmetics.trails.HelixTrail;
import io.github.Leonardo0013YT.UltraSkyWars.cosmetics.trails.Trail;
import io.github.Leonardo0013YT.UltraSkyWars.cosmetics.windances.*;
import io.github.Leonardo0013YT.UltraSkyWars.cosmetics.wineffects.*;
...
public class CosmeticManager {
    ...
    public void setLastPage(String type, int lastPage) {
        if (getLastPage(type) < lastPage) {
            this.lastPage.put(type, this.lastPage.getOrDefault(type, 0));
        }
    }
