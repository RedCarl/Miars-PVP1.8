...
public class SWPlayer {
    ...
    public void addHead(String rarity, String name, long date) {
        heads.putIfAbsent(rarity, new HashMap<>());
        if (headsCollected > UltraSkyWars.get().getCm().getMaxCollectHeads()) {
    ...
    public void addSouls(int souls) {
        if (UltraSkyWars.get().getIjm().isSoulWellInjection()) {
            this.souls = Math.min(this.souls += souls, UltraSkyWars.get().getIjm().getSoulwell().getSwm().getMaxSouls(soulWellMax));
        } else {
            this.souls += souls;
        }
    }
    ...
    public void setSouls(int souls) {
        if (UltraSkyWars.get().getIjm().isSoulWellInjection()) {
            this.souls = Math.min(souls, UltraSkyWars.get().getIjm().getSoulwell().getSwm().getMaxSouls(soulWellMax));
        } else {
            this.souls = souls;
        }
    }
