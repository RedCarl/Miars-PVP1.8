...
import com.andrei1058.bedwars.proxy.lobby.listener.BlockListener;
import com.andrei1058.bedwars.proxy.lobby.listener.PlayerListener;
...
public class BedWarsProxy extends JavaPlugin implements BedWars {
    ...
    public void onEnable() {
        ...
        registerListeners(new LangListeners(), new ArenaSelectorListener(), new CacheListener(),new PlayerListener(),new BlockListener());
