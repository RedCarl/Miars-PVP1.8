...
public class ScoreBoardManager {
    ...
    private void updateBoard(FastBoard board) {
        ...
        board.updateTitle("&eFaction &8┃ &e"+ ServerInfoDataStorage.getInstance().getServerInfo().getNameCn());
        ...
        lines.add("&7您还没有派系，请使用");
        lines.add("&7指令 &c/f &7来查看教程。");
        lines.add("&7创建或加入一个派系！");
