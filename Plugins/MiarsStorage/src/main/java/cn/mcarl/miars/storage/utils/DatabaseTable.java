...
public class DatabaseTable {
	...
	public InsertBuilder<PreparedSQLUpdateAction<Integer>> createInsert(SQLManager sqlManager) {
		return sqlManager.createInsert(getTableName());
	}

	public InsertBuilder<PreparedSQLUpdateBatchAction<Integer>> createInsertBatch(SQLManager sqlManager) {
		return sqlManager.createInsertBatch(getTableName());
	}

	public ReplaceBuilder<PreparedSQLUpdateAction<Integer>> createReplace(SQLManager sqlManager) {
		return sqlManager.createReplace(getTableName());
	}

	public ReplaceBuilder<PreparedSQLUpdateBatchAction<Integer>> createReplaceBatch(SQLManager sqlManager) {
